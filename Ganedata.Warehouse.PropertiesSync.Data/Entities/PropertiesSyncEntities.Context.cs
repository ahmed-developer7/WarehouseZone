...
namespace Ganedata.Warehouse.PropertiesSync.Data.Entities
{
    ...
    public partial class PropertiesSyncEntities : DbContext
    {
        public PropertiesSyncEntities()
            : base("name=PropertiesSyncEntities")
        {
        }
        public PropertiesSyncEntities(string name)
            : base(name)
        {
        }
